...
class ListAnswer extends Eloquent
{    
    /*
	|--------------------------------------------------------------------------
	| Model Options
	...
	*/
    ...
    public function delete()
    {
        ...
        QuestionAnswerRel::where("list_answer_id", '=', $this->id)->where('user_id', '=', Auth::user()->id)->delete();
    ...
    {
        $answer = ListAnswer::where('plan_id','=',$plan_id)
